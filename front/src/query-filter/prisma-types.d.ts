// Link: https://github.com/prisma/prisma/issues/6980
import { Prisma, PrismaClient } from "./prisma-client";
import * as PrismaRuntime from "./prisma-client-library";

import PrismaTypes = PrismaRuntime.Types;

export { PrismaTypes };
export { Prisma, PrismaClient } from "./prisma-client";
export * as PrismaRuntime from "./prisma-client-library";
...
export type CreateArgs<N extends ModelName> =
  PrismaModelType<N>["operations"]["create"]["args"]["data"];
export type UpdateArgs<N extends ModelName> =
  PrismaModelType<N>["operations"]["update"]["args"]["data"];
